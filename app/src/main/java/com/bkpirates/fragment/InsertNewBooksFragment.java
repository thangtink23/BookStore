...
public class InsertNewBooksFragment extends FragmentActivity implements OnClickListener {
	...
	public static final String UPLOAD_URL = "http://camlinhshop.com/JSON_API/add_book.php";
	...
	int check = 0;
	int dauhieu=0;
	public static  BookEntity bookEntity = new BookEntity() ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setWidgets();
		try{
			dauhieu = getIntent().getExtras().getInt("dauhieu");
		} catch (Exception e){
			dauhieu=0;
		}
		if(dauhieu==1)
